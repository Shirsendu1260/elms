...
<body>
    ...
    <div class="form-container">
        <div class="card mt-1">
            ...
            <div class="card-body">
                <form class="d-flex my-2" role="search" action="..\admin\search_rated_book.php" method="post">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination pagination-sm justify-content-end mt-2">
                        <li class="page-item">
                            <a class="page-link" href="..\admin\book_ratings.php?page=<?= $previous; ?>">Previous</a>
                        </li>
                        <?php for($i=1; $i<$total_pages; $i++) : ?>
                        <li class="page-item"><a class="page-link" href="..\admin\book_ratings.php?page=<?= $i; ?>">
                                <?php echo $i; ?>
                            </a></li>
                        <?php endfor; ?>
                        <li class="page-item">
                            <a class="page-link" href="..\admin\book_ratings.php?page=<?= $next; ?>">Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
