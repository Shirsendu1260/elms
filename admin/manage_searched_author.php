...
<head>
    ...
    <title>eLMS | Manage Searched Author</title>
    ...
    <div class="form-container">
        <div class="card mt-1">
            ...
            <div class="card-body">
                    ...
                    <table class="table table-sm">
                        <?php
                            if(isset($_POST['submit'])){
                                $search = $_POST['search'];
                                $search_sql = "SELECT * FROM authors WHERE name LIKE '%$search%';";
                                    ...
                                    if(mysqli_num_rows($search_sql_run) > 0){
                                        ...
                                        echo '<tbody>
                                                    <tr>
                                                        <td>'.$aid.'</td>
                                                        <td>'.$name.'</td>';
                                        $url1 = "../admin/edit_author.php"."?aid=".base64_encode($aid);
                                        $url2 = "../admin/delete_author.php"."?aid=".base64_encode($aid);
                                        echo '<td>
                ...
                <a href="../admin/manage_authors.php"><button class="btn btn-primary">Back</button></a>
            </div>
        </div>
    </div>
