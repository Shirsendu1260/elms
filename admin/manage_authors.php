...
<head>
    ...
    <title>eLMS | Manage Authors</title>
...
<body>
    <?php
        ...
        $result = $connection -> query("SELECT COUNT(*) AS count FROM authors;");
    ...
    <div class="form-container">
        <div class="card mt-1">
            <div class="card-header fs-5">
                Manage Authors<br>
                <span class="fs-6">
                    Total Registered Authors: <span>
                        <?php echo count_total_authors();?>
                    </span>
                </span>
            </div>
            <div class="card-body">
                <form class="d-flex my-2" role="search" action="..\admin\manage_searched_author.php" method="post">
                    <input class="form-control me-2" type="text" name="search" placeholder="Search any author"
                        aria-label="Search">
                    ...
                    <table class="table table-sm">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $url1 = "../admin/edit_author.php"."?aid=".base64_encode($aid); ?>
                                    <?php $url2 = "../admin/delete_author.php"."?aid=".base64_encode($aid); ?>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination pagination-sm justify-content-end mt-2">
                        <li class="page-item">
                            <a class="page-link" href="..\admin\manage_authors.php?page=<?= $previous; ?>">Previous</a>
                        </li>
                        <?php for($i=1; $i<$total_pages; $i++) : ?>
                        <li class="page-item"><a class="page-link" href="..\admin\manage_authors.php?page=<?= $i; ?>">
                                <?php echo $i; ?>
                            </a></li>
                        <?php endfor; ?>
                        <li class="page-item">
                            <a class="page-link" href="..\admin\manage_authors.php?page=<?= $next; ?>">Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
