...
<head>
    ...
    <title>eLMS | Add New Author</title>
...
<body>
    ...
    <div class="form-container">
        <div class="card col-md-6">
            <div class="card-body">
                <h4 class="card-title my-2 text-center fw-bold">Add New Author</h4>
                <form action="" method="post" class="my-3">
                    <div class="form-group mb-2">
                        <input type="text" name="name" placeholder="Author Name" class="form-control required">
                    </div>
                    <button type="submit" name="add_author" class="btn btn-outline-primary my-2">Add Author</button>
                </form>
                <?php
