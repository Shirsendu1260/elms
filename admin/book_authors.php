...
<body>
    ...
    <div class="form-container">
        <div class="card mt-1">
            ...
            <div class="card-body">
                <form class="d-flex my-2" role="search" action="..\admin\search_author.php" method="post">
                    <input class="form-control me-2" type="text" name="search" placeholder="Search any author" aria-label="Search">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination pagination-sm justify-content-end mt-2">
                        <li class="page-item">
                            <a class="page-link"
                                href="..\admin\book_authors.php?page=<?= $previous; ?>">Previous</a>
                        </li>
                        <?php for($i=1; $i<$total_pages; $i++) : ?>
                        <li class="page-item"><a class="page-link"
                                href="..\admin\book_authors.php?page=<?= $i; ?>">
                                <?php echo $i; ?></a></li>
                        <?php endfor; ?>
                        <li class="page-item">
                            <a class="page-link" href="..\admin\book_authors.php?page=<?= $next; ?>">Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
