...
<head>
    ...
    <title>eLMS | Manage Categories</title>
...
<body>
    ...
    <div class="form-container">
        <div class="card mt-1">
            ...
            <div class="card-body">
                <form class="d-flex my-2" role="search" action="..\admin\manage_searched_category.php" method="post">
                    <input class="form-control me-2" type="text" name="search" placeholder="Search any category"
                        aria-label="Search">
                    ...
                    <table class="table table-sm">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $url1 = "../admin/edit_category.php"."?cid=".base64_encode($cid); ?>
                                    <?php $url2 = "../admin/delete_category.php"."?cid=".base64_encode($cid); ?>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination pagination-sm justify-content-end mt-2">
                        <li class="page-item">
                            <a class="page-link"
                                href="..\admin\manage_categories.php?page=<?= $previous; ?>">Previous</a>
                        </li>
                        <?php for($i=1; $i<$total_pages; $i++) : ?>
                        <li class="page-item"><a class="page-link"
                                href="..\admin\manage_categories.php?page=<?= $i; ?>">
                                <?php echo $i; ?>
                            </a></li>
                        <?php endfor; ?>
                        <li class="page-item">
                            <a class="page-link" href="..\admin\manage_categories.php?page=<?= $next; ?>">Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
