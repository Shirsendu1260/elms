...
<body>
    ...
    <div class="form-container">
        <div class="card col-md-6">
            <div class="card-body">
                <h4 class="card-title my-2 text-center fw-bold">Update Profile Details</h4>
                <form action="..\user\update.php" method="post" class="my-3">
                    <div class="form-group mb-2">
                        <label for="uid">ID</label>
                        <input type="number" name="uid" class="form-control" value="<?php echo $uid; ?>" disabled>
                    </div>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <textarea name="address" rows="4" class="form-control"
                            style="resize: none;"><?php echo $address; ?></textarea>
                    </div>
