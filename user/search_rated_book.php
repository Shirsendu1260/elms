    ...
    <div class="form-container">
        <div class="card mt-1">
            ...
            <div class="card-body">
                    ...
                    <table class="table table-sm">
                        <?php
                            if(isset($_POST['submit'])){
                                $search = $_POST['search'];
                                $search_sql = "SELECT books.bid, books.name, ROUND(IFNULL(AVG(ratings.rating), 0), 1) AS rating, books.isbn FROM books JOIN ratings ON books.bid = ratings.book_id WHERE books.name LIKE '%$search%' GROUP BY books.bid, books.name;";
                ...
                <a href="../user/book_ratings.php"><button class="btn btn-primary">Back</button></a>
            </div>
        </div>
    </div>
